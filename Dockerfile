...
WORKDIR /telegram-bot-api-repo/telegram-bot-api
...
COPY --from=build /telegram-bot-api-repo/telegram-bot-api/build/telegram-bot-api /telegram-bot-api/telegram-bot-api
